...
# Re-exportar desde _exports_excel_json para evitar duplicacion
build_patient_excel_bytes = _build_patient_excel_bytes_impl
build_patient_json_bytes = _build_patient_json_bytes_impl
