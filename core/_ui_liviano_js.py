  ...
  try {
    ...
    function ensureStyle() {
      ...
      style.textContent = [
        ...
        "box-shadow:0 8px 28px rgba(2,6,23,.30), inset 0 1px 0 rgba(255,255,255,.10);",
        "border:1px solid rgba(148,163,184,0.22);",
        "cursor:pointer;opacity:.90;transition:opacity 0.15s,width 0.18s,background 0.2s;}",
        ...
        "background:rgba(15,23,42,0.42);border:1px solid rgba(148,163,184,0.22);",
        "backdrop-filter:blur(16px) saturate(1.6);-webkit-backdrop-filter:blur(16px) saturate(1.6);",
