...
if not st.session_state.get("entered_app", False):
    st.markdown("""
        <style>
            ...
            .hero { text-align: center; padding: 60px 20px; font-family: 'Inter', sans-serif; }
            .hero-title { font-size: 4rem; font-weight: 900; background: linear-gradient(135deg, #fff, #38bdf8); -webkit-background-clip: text; -webkit-text-fill-color: transparent; }
            .hero-card { background: rgba(255,255,255,0.03); border: 1px solid rgba(255,255,255,0.1); border-radius: 24px; padding: 30px; margin: 10px; }
        </style>
        <div class="hero">
            <h1 class="hero-title">MediCare Enterprise PRO</h1>
            <p style="color:#94a3b8; font-size:1.2rem; margin-bottom:40px;">Infraestructura Digital de Alto Rendimiento para Salud</p>
            <div style="display: flex; flex-wrap: wrap; justify-content: center;">
                <div class="hero-card"><h3>📍 GPS</h3><p>Trazabilidad total.</p></div>
                <div class="hero-card"><h3>🩺 Clínica</h3><p>Gestión multimedia.</p></div>
                <div class="hero-card"><h3>⚖️ Legal</h3><p>Blindaje jurídico.</p></div>
            </div>
        </div>
