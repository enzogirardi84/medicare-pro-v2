...
if not st.session_state.entered_app:
    ...
    html_lines = [
        ...
        ".trust-strip { max-width: 1180px; width: 100%; display: flex; flex-wrap: wrap; gap: 12px; justify-content: center; margin: 0 0 34px; }",
        ".trust-pill { padding: 12px 16px; border-radius: 999px; background: rgba(15, 23, 42, 0.8); border: 1px solid rgba(148, 163, 184, 0.18); color: #e2e8f0; font-size: 0.92rem; font-weight: 700; }",
        ".spotlight-grid { max-width: 1180px; width: 100%; display: grid; grid-template-columns: 1.15fr 0.85fr; gap: 24px; margin: 0 0 32px; }",
        ".spotlight-card { background: linear-gradient(145deg, rgba(15, 23, 42, 0.92), rgba(11, 18, 32, 0.98)); border: 1px solid rgba(56, 189, 248, 0.12); border-radius: 30px; padding: 30px 30px 28px; box-shadow: 0 18px 40px rgba(0,0,0,0.22); }",
        ...
        ".check-item { color: #e2e8f0; font-size: 0.96rem; line-height: 1.6; padding: 12px 14px; border-radius: 16px; background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(56, 189, 248, 0.08); }",
        ".benefit-band { max-width: 1180px; width: 100%; background: linear-gradient(145deg, rgba(10, 16, 30, 0.96), rgba(15, 23, 42, 0.98)); border-radius: 32px; border: 1px solid rgba(148, 163, 184, 0.12); padding: 34px 30px; margin: 0 0 50px; }",
        ".benefit-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin-top: 20px; }",
        ".benefit-card { padding: 20px 18px; border-radius: 22px; background: rgba(30, 41, 59, 0.45); border: 1px solid rgba(56, 189, 248, 0.08); }",
        ...
        ".segment-card { padding: 26px 22px; border-radius: 26px; background: linear-gradient(145deg, rgba(22, 32, 55, 0.75), rgba(8, 15, 30, 0.96)); border: 1px solid rgba(56, 189, 248, 0.1); box-shadow: 0 12px 24px rgba(0,0,0,0.18); }",
        ...
        ".closing-panel { padding: 30px 28px; border-radius: 30px; background: linear-gradient(135deg, rgba(14, 165, 233, 0.14), rgba(79, 70, 229, 0.18)); border: 1px solid rgba(99, 102, 241, 0.22); box-shadow: 0 18px 40px rgba(0,0,0,0.18); }",
        ...
        "@media (max-width: 768px) { .landing-page { padding: 42px 18px 24px; } .grid-cards { gap: 20px; margin-bottom: 40px; } .glass-card-pro { padding: 28px 22px; min-height: auto; } .contact-section-pro { padding: 36px 18px; border-radius: 26px; } .contact-grid-pro { gap: 20px; } .benefit-band { padding: 28px 20px; } .trust-strip { justify-content: flex-start; } }",
        "</style>",
